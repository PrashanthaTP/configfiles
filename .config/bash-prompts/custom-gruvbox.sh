...
function __prompt {
  ...
  function git_branch {
    ...
    printf '\001%s\002\001%s\002 \001%s\002 %s \001%s\002\001%s\002' \
      "${BG_COLOR}" "${YELLOW}" "${TXT_COLOR}" "${BRANCH}" "${RESET}" "${FG_COLOR}"
  }
  ...
  function init_prompt {
    EXIT_CODE="$?"
    PS1="\n"
    PS1+="\001${BLACK1_BG}\002\001${GRAY}\002\u@\001${BOLD}\002\001${GRAY}\002\h " # user@host
